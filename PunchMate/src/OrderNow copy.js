            ...
            <SafeAreaView>
                ...
                <View style={{ flexDirection: 'row', marginTop: 2 }}>
                    ...
                    <View style={{ flexDirection: 'row', position: 'relative', zIndex: 2 }}>
                        ...
                        {/* <Image
                            style={{ width: SCREEN_WIDTH, height: 250, alignSelf: 'center' }}
                ...
                <View style={{
                    backgroundColor: '#fff', borderRadius: 30, padding: 10, marginTop: -20, zIndex: 3,
                    shadowColor: "#000", shadowOffset: { width: 0, height: 3, }, shadowOpacity: 0.29, shadowRadius: 4.65, elevation: 7,
                }}>
                    {/* <View style={{ flex: 4, margin: 0, marginTop: -10 }}> */}
                    ...
                    />
                    {/* </View> */}
                    <View style={{ position: 'relative', bottom: 0, left: 0, right: 50, top: -60 }}>
